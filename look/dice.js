...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-815bda20');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-815bda20');}
...
var brandEl=document.querySelector('.rl-brand-815bda20');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
